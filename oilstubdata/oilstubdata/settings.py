"""
Django settings for oilstubdata project.
...
if os.getenv("PYTHON_ENV") == "dev":
    ...
    settings_name = os.getenv("SETTINGS_NAME", "oilstub-backend-setting")
...
ALLOWED_HOSTS = [
    'oilstub-backend-prrtm2ky5q-uc.a.run.app',
    'localhost'
]
